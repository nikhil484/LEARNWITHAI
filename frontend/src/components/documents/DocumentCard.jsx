...
//  toFixed(n) is a JavaScript Number method.
// It rounds a number and keeps only n digits after the decimal point.
...
const DocumentCard = ({ document,onDelete}) => {
  ...
  return <div className='group relative bg-white/80 backdrop-blur-xl border-slate-200/60 rounded-2xl p-5 hover:border-slate-300/60 hover:shadow-xl  hover:shadow-slate-200/50 transition-all duration-300 flex flex-col justify-between cursor-pointer hover:translate-y-1'
