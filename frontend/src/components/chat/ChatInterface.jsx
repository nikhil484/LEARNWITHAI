...
const ChatInterface = () => {
            ...
            return(
                <div  key={index}  className={`flex items-center gap-3 my-4 ${isUser ? 'justify-end':''}`}>
                 ...
                 <div className={`max-w-lg p-4 rounded-2xl  shadow-sm ${
                    isUser
                    ? 'bg-linear-to-r from-emerald-500 to-teal-500 text-white  border-br-md'
        ...
        return (
            <div className='flex flex-col h-[70vh] bg-white/80 backdrop-blur-xl border border-slate-200/60  rounded-2xl items-center justify-center shadow-xl shadow-slate-200/50'>
                <div className='w-14 h-14 rounded-2xl bg-linear-to-br from-emerald-100 to-teal-100  flex items-center justify-center mb-4'>
                    <MessagesSquare className='w-7 h-7' strokeWidth={2} />
                </div>
                <Spinner />
    ...
    return (
                    ...
                    <div className='flex items-center gap-3 my-4'>
                        ...
                        <div className='flex items-center gap-2 px-4 py-3 rounded-2xl rounded-bl-md bg-white border  border-slate-200/60'>
                            <div className='flex gap-1'>
                                ...
                                <span className='w-2 h-2 bg-slate-400 rounded-full animate-bounce' style={{ animationDelay: '3000ms' }}></span>
        ...
        <div className='p-5  border-t border-slate-200/60 bg-white/80'>
           ...
           className='flex-1  h-12 px-4 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10'
           disabled={loading}/>
